                        ...
                        <ul class="m-topbar__nav m-nav m-nav--inline">
                             ...
                             m-dropdown-persistent="1">
                                ...
                                <div class="m-dropdown__wrapper">
                                    ...
                                    <div class="m-dropdown__inner">
                                        <div class="m-dropdown__header m--align-center" style="background: url({{ asset('backend/app/media/img/misc/notification_bg.jpg')}}); background-size: cover;">
                            ...
                            @if (Auth::user())
                                ...
                                <div class="m-dropdown__wrapper">
                                    ...
                                    <div class="m-dropdown__inner">
                                        <div class="m-dropdown__header m--align-center" style="background: url({{ asset('backend/app/media/img/misc/user_profile_bg.jpg')}}); background-size: cover;">
